    ...
    <div className="app-container">
      <div className="content-container">
        <div className="text-section">
          ...
          <p>
            Инновационная образовательная платформа, превращающая обучение в увлекательную игру! Осваивай программирование и готовься к ЕНТ с помощью интерактивных курсов, уровней и наград.
          </p>
